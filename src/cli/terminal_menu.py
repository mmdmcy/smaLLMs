    ...
    def _run_benchmark_flow(self, reader: CrossPlatformKeyReader) -> None:
        ...
        benchmark_mode = self._select_one(
            ...
            options=[
                ...
                MenuOption("Long context suite", ("suite", "long_context_suite"), "Graphwalks and MRCR public long-context evaluations"),
                MenuOption("OpenAI public suite", ("suite", "openai_public_suite"), "Runnable public subset of recent OpenAI-style disclosures"),
                MenuOption("Frontier report suite", ("suite", "frontier_report_suite"), "Broad local subset of commonly reported lab benchmarks"),
                MenuOption("Serious suite", ("suite", "serious_suite"), "Leaderboard-grade open benchmark sweep"),
